...
function calcTotal() {
   ...
   try{
      ...
      if(wgtBox.value === "0"){
      throw console.log("Hello there");
      }
    }catch(error){
        msgBox.innerHTML = "Please enter number greater than zero";
    }
    ...
    if(distBox.value === "0"){
        throw console.log("Hello there 2.0");
    }
    }catch(error){
        msgBox.innerHTML = "Please enter positive number";
    }
